...
<section id="section-couple" class="section section--couple section--couple-centered" data-section="couple">
    <div class="section-inner">
        <h2 class="section-title">Mempelai</h2>

        <div class="couple-stack">
            <article class="couple-person couple-person--bride couple-person--stacked">
                <div class="couple-photo couple-photo--large">
            ...
            <div class="couple-and couple-and--vertical"><span>&amp;</span></div>

            <article class="couple-person couple-person--groom couple-person--stacked">
                <div class="couple-photo couple-photo--large">
